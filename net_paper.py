...
class Generater(nn.Module):
    ...
    def __init__(self,channels,base,M,mode):
        ...
        self.sample1 = nn.Conv2d(self.channels,self.base,kernel_size=3,padding=1,stride=2,bias=False)
        self.sample2 = nn.Conv2d(self.base,    self.base,kernel_size=3,padding=1,stride=2,bias=False)
        self.sample3 = nn.Conv2d(self.base,    self.M,   kernel_size=3,padding=1,stride=2,bias=False)
        ...
        self.up1 = nn.ConvTranspose2d(self.base, self.base, kernel_size=4, padding=1, stride=2, bias=False)
    ...
    def forward(self,input,idx,savepath):
        ...
        output = self.relu(self.up3(output))
